...
def step1(user: MyUser, userList):
    ...
    chromeCtrl.tweeter_follow('https://twitter.com/atlantis_TW')
    chromeCtrl.tweeter_follow('https://twitter.com/Metaverse_io')
    chromeCtrl.youtube_subcribe('https://www.youtube.com/channel/UCgk_Xw58_S5uVmepnuFj1QQ')
    ...
    teleCtrl.telegram_join_channel('https://t.me/atlantisANN')
    teleCtrl.telegram_join_channel('https://t.me/atlantismetaverse')
    pass
...
def step2(user: MyUser, userList):
    ...
    teleCtrl.telegram_join_channel('https://t.me/AtlantisMetaverseAirdropbot?start=r04719220511')
    ...
    pyautogui.typewrite(["enter"])
    time.sleep(2)
    keyboard_type_job(user.youtubeChannelLink)
    pyautogui.typewrite(["enter"])
    time.sleep(2)
