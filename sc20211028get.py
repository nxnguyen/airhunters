...
def step1(user: MyUser, userList):
    ...
    chromeCtrl.tweeter_follow('https://twitter.com/GetGetSwap')
    chromeCtrl.tweeter_retweet('https://twitter.com/GetGetSwap/status/1453243690550505473',3)
    ...
    teleCtrl.telegram_join_channel('https://t.me/Getswap')
    teleCtrl.telegram_join_channel('https://t.me/GetSwapChannel')
    pass
...
def step2(user: MyUser, userList):
    ...
    teleCtrl.telegram_join_channel('https://t.me/GetswapAirdropBot?start=2069310083')
    time.sleep(2)

    pyautogui.click(1549, 1656)
    time.sleep(5)
    pyautogui.rightClick(1433, 1494)
    time.sleep(1)
    pyautogui.click(1536, 1185)
    time.sleep(5)
