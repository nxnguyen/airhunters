...
def step1(user: MyUser, userList):
    ...
    chromeCtrl.tweeter_follow('https://twitter.com/BeldexCoin')
    chromeCtrl.tweeter_retweet('https://twitter.com/BeldexCoin/status/1455249836026970119',0)
    # chromeCtrl.tweeter_liketweet('https://twitter.com/GinzaNetwork/status/1453592611101429766',14)
    # retweet_Link = chromeCtrl.tweeter_quote_tweet('https://twitter.com/GinzaNetwork/status/1453592611101429766', findQuoteBtnFunc,
    #     quoteTweet, userList)
    # print(retweet_Link)
    #
    # time.sleep(1)
    ...
    teleCtrl.telegram_join_channel('https://t.me/official_beldex')
    teleCtrl.telegram_join_channel('https://t.me/beldexcoin')
...
def step2(user: MyUser, userList):
    ...
    teleCtrl.telegram_join_channel('https://t.me/BeldexAirdropBot?start=2069310083')
