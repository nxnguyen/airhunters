...
def step1(user: MyUser, userList):
    global retweet_Link
    global retweet_Link2

    chromeCtrl = ChromeController(user)
    chromeCtrl.chrome_open()
    chromeCtrl.youtube_subcribe('https://www.youtube.com/c/Airdropninja')

    chromeCtrl.tweeter_follow('http://twitter.com/infinitypad_io')
    ...
    retweet_Link = chromeCtrl.tweeter_quote_tweet(
        'https://twitter.com/InfinityPad_io/status/1452369576243519488', findQuoteBtnFunc,
        quoteTweet, userList)
    print(retweet_Link)

    retweet_Link2 = chromeCtrl.tweeter_quote_tweet(
        'https://twitter.com/CryptoTownEU/status/1451188255441833984?t=j1qMLotydyl8BOtmPc6xEA&s=19', findQuoteBtnFunc,
        quoteTweet, userList)
    print(retweet_Link2)
    ...
    teleCtrl.telegram_join_channel('https://t.me/infinitypad_io')
    teleCtrl.telegram_join_channel('https://t.me/infinitypad')
    teleCtrl.telegram_note_down(retweet_Link)
    teleCtrl.telegram_note_down(retweet_Link2)
    pass
...
def step2(user: MyUser, userList):
    ...
    teleCtrl.telegram_join_channel('https://t.me/InfinitypadAirdropbot?start=r09571682711')

    pyautogui.click(1605, 1780)
    time.sleep(3)
    pyautogui.click(1615, 1675)
    time.sleep(3)
    pyautogui.click(1621, 1666)
    time.sleep(3)
    pyautogui.click(1621, 1666)
    ...
    pyautogui.typewrite(["enter"])
    time.sleep(3)
    pyautogui.click(1576, 1679)
    time.sleep(1)
    keyboard_type_job(retweet_Link2)
    pyautogui.typewrite(["enter"])
